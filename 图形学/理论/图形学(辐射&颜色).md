...
$$
\begin{aligned}
& I = \frac{\Phi}{\omega} \quad \omega = \frac{A}{r^2} \quad \omega:立体角 \\
& \mathrm d\omega = \frac{r \sin \theta \cdot \mathrm d\phi \cdot r \mathrm d\theta }{r^2} = \sin \theta \mathrm d\theta \mathrm d\phi  \\
& 球面立体角:\omega = \int_{\Omega^{+}} \mathrm d\omega = \int_0^{2\pi} \mathrm d\phi \int_0^\pi \sin \theta \mathrm d\theta = 4 \pi  \\
\end{aligned}
$$
...
& P:\mathrm{Photometry}中的某个物理量 \quad R:\mathrm{Radiometry}中与之对应的物理量  \\
& s(\lambda):\mathrm{SPD}函数 \quad k(\lambda):\mathrm{Photometry \ Curve}函数  \\
\end{aligned}
$$

## 物理量

| 符号   | 名称                         | 单位                       | $1\mathrm{cd}$理想点光源的例子                               |
| ------ | ---------------------------- | -------------------------- | ------------------------------------------------------------ |
| $\Phi$ | 光通量(luminous flux)        | $\mathrm{lm[=cd\cdot sr]}$ | 在任意包围光源的曲面上，总光通量为$4\pi \ \mathrm{lm}$       |
| $E$    | 光照度(illuminance)          | $\mathrm{lux[=lm/m^2]}$    | 距离光源0.1$\mathrm{m}$ ，法线与光线夹角为60°的微小平面上各点，辐照度为 $50 \mathrm{lux}$ |
| $I$    | 光强强度(luminous intensity) | $\mathrm{cd}$              | 在空间中的任意位置，光照强度为$1 \mathrm{cd}$                |
| $L$    | 亮度(luminance)              | $\mathrm{nit[=cd/m^2]}$    | 在空间中的任意位置，亮度为无穷大                             |
...
$$
\begin{aligned}
& I=\frac{\mathrm d \phi}{\mathrm d\omega} \quad E=\frac{\mathrm d \phi}{\mathrm d A}\quad L=\frac{\mathrm d^2 \phi}{\mathrm d\omega \mathrm d A\cos \theta}=\frac{\mathrm dI}{\mathrm dA \cos \theta}=\frac{\mathrm dE}{\mathrm d\omega \cos \theta}  \\
& \mathrm d\phi:照射微小区域的光线的功率 \quad \mathrm d\omega:微小立体角 \quad \mathrm dA:微小面积  \\
& I:光照强度 \quad E:光照度 \quad L:亮度  \\
& \\
& 被理想点光源\textbf{直射}时:I \equiv \frac{\Phi}{4\pi} \quad E=\frac{\Phi}{4\pi r^2} \quad  \\
& \Phi:光源总功率 \quad r:照射位置到光源的距离 \quad  \\
\end{aligned}
$$
