...
$$
\mathrm{Cook-Torrance}模型:f(\mathbf p,\mathbf l,\mathbf v) = f_d(\mathbf v,\mathbf l;\mathbf n,\rho,r) + \frac{D(\mathbf h;\mathbf n,\alpha)F(\mathbf v,\mathbf h;F_0)G(\mathbf l,\mathbf v;\mathbf n,\alpha)}{4 \ (\mathbf l \cdot \mathbf n)(\mathbf v \cdot \mathbf n)} \hfill \\
给定物体表面一点\mathbf p,考虑单一光源:\underset{direct}{L_{r}(\mathbf p,\mathbf v)}= E(-\mathbf l,\mathbf p) (\mathbf l \cdot \mathbf n) \left[f_d(\mathbf v,\mathbf l;\mathbf n,\rho,r) + \frac{D(\mathbf h;\mathbf n,\alpha)F(\mathbf v,\mathbf h;F_0)G(\mathbf l,\mathbf v;\mathbf n,\alpha)}{4 \ (\mathbf l \cdot \mathbf n)(\mathbf v \cdot \mathbf n)} \right] \hfill \\
...
$$
\mathrm{Lambert \ Diffuse}:f_d(\mathbf v,\mathbf l;\mathbf n,\rho,r)= (1-F(\mathbf v,\mathbf h;F_0))\frac{\rho}{\pi} \hfill \\
\mathrm{Frostbite \ Diffuse}:f_d(\mathbf v,\mathbf l;\mathbf n,\rho,r)= s(\mathbf l;\mathbf n,r)s(\mathbf v;\mathbf n,r)\mathrm{Lerp}\{1,k_e,r\}\frac{\rho}{\pi} \hfill \\
...
\\
只考虑环境光直射时:L_r^0(\mathbf p,\mathbf v)=\int_{\Omega^{+}} L(-\mathbf l,\mathbf p)V(\mathbf p,-\mathbf l) (\mathbf l \cdot \mathbf n)f(\mathbf p,\mathbf l,\mathbf v) \mathrm d\mathbf l \hfill \\
