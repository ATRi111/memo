...
\\
如果物体没有镜面反射: \hfill \\
L_r(\mathbf p,\mathbf v)= \int_{\Omega^{+}} L(-\mathbf l,\mathbf p) (\mathbf l \cdot \mathbf n) \frac{\rho}{\pi} \mathrm d\mathbf l=\frac{\rho}{\pi}E_i(\rightarrow\mathbf p) \hfill \\
...
$$
\mathrm{Schlick \ Fresnel}:F(\mathbf p,\mathbf l,\mathbf v) \approx \mathrm{Lerp}\{F_0,1,(1 - \mathbf v \cdot \mathbf h)^5\}=F_0 + (1-F_0)(1 - \mathbf v \cdot \mathbf h)^5 \hfill \\
\\
...
\Omega:光源覆盖的球面区域 \quad \phi:\mathbf M\mathbf l与天顶(\mathbf n)的夹角 \quad \mathbf J:\mathrm{Jacobi}矩阵 \hfill \\
$$
...
$$
\underset{env\_specular}{L_r(\mathbf p,\mathbf v)}= \int_{\Omega^{+}} L_r(-\mathbf l,\mathbf p)V(\mathbf p,\mathbf l) \frac{D(\mathbf n,\mathbf l)F(\mathbf n,\mathbf l)G(\mathbf p,\mathbf l,\mathbf v)}{4 \ (\mathbf v \cdot \mathbf n)} \mathrm d\mathbf l \hfill \\
\approx L_r(-\mathbf r,\mathbf p) \int_{\Omega^{+}} \frac{D(\mathbf n,\mathbf l)F(\mathbf n,\mathbf l)G(\mathbf p,\mathbf l,\mathbf v)}{4 \ (\mathbf v \cdot \mathbf n)} \mathrm d\mathbf l  \hfill \\
